...
<!-- header -->
      ...
      <div class="container" style="padding-top:50px;">
            ...
            <div style="padding:30px;">  <a href="changeco_password.jsp?username=<%=username%>" class="btn-lg btn-warning" style="padding-left:70px;padding-right:70px;">Change Password </a> <br> </div>
